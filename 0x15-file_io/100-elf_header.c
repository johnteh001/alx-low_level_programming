...
int main(int argc, char *argv[])
{
	...
	char *elf_data[] = {"None", "2's complement, little endian", "2's complement, big endian"};
	char *elf_osabi[] = {"UNIX - System V", "HP-UX", "NetBSD", "GNU", "Solaris", "AIX", "IRIX","FreeBSD", "Tru64", "Novell Modesto", "OpenBSD", "OpenVMS", "NonStop Kernel","AROS", "Fenix OS", "CloudABI", "OpenVOS"};
	...
	printf("  Magic:   %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x\n",
		...
		elf_header.e_ident[EI_ABIVERSION], elf_header.e_ident[EI_PAD], elf_header.e_ident[EI_PAD], elf_header.e_ident[EI_PAD],
		elf_header.e_ident[EI_PAD], elf_header.e_ident[EI_PAD], elf_header.e_ident[EI_PAD], elf_header.e_ident[EI_PAD]);
